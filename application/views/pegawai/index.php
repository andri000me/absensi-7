...
<div class="container"> 
    ...
    <div class="row mt-3 justify-content-center">
        ...
        <div class="col-md-6 text-center" >
            <a id="absen_link" href="<?php echo site_url('absen/add_absen');?>">
    ...
    <div class="row mt-3 justify-content-center">
        <div class="col-md-2">
            <button id="inputkerja" type="button" class="btn btn-success btn-sm btn-block" data-toggle="modal" data-target="#addkerja">Input Pekerjaan</button>
        </div>
        <div class="col-md-2">
        </div>
        <div class="col-md-4">
            <h4 class="text-center">Kegiatan Harian</h4>
        </div>
        <div class="col-md-4">
        ...
        <div class="table-responsive">
          <table class="table table-hover" id="mytable">
            <thead class="thead-light">
              <tr>
                <th scope="col" width="15%">Tanggal Input</th>
                <th scope="col" width="15%">Jam</th>
                <th scope="col" width="60%">Pekerjaan</th>
            ...
            <?php foreach($pekerjaan as $kerja):?>
              <tr>
                <th scope="row"><?= $kerja['tgl_aktivitas']?></th>
                <td><?= substr($kerja['jam_mulai'],0,5) . " - " . substr($kerja['jam_selesai'], 0, 5)  ?></td>
                <td><?= $kerja['isi_aktivitas']?></td>
                <td>
                    <a href="<?= base_url(); ?>absen/hapus_pekerjaan/<?= $kerja['id_aktivitas']; ?>"
                        class="badge badge-danger float-right tombol-hapus">hapus </a>
                    <a href="#" data-toggle='modal' data-target='#edit<?= $kerja['id_aktivitas']?>' class="badge badge-success float-right">ubah </a>
                      <!-- Modal -->
                      <div class="modal fade" id="edit<?= $kerja['id_aktivitas']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        ...
                                        <form class="" action="<?php echo site_url('absen/edit_kerja/').$kerja['id_aktivitas']."/0"; ?>" method="post" id="formadd<?= $kerja['id_aktivitas']; ?>">
                                                    <div class="form-row">
                                                    <div class="form-group col-md-5">
                                                        <label for="start_h">Mulai</label>
                                                        <div class="row">
                                                        <?php
                                                            $jam_mulai = substr($kerja['jam_mulai'], 0, 2);
                                                            $menit_mulai = substr($kerja['jam_mulai'], 3, 2);
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        ...
                                                        <?php
                                                            $jam_selesai = substr($kerja['jam_selesai'], 0, 2);
                                                            $menit_selesai = substr($kerja['jam_selesai'], 3, 2);
                                                            //echo $jam_mulai . ":" .$menit_mulai;
                                                        ?>
                                                    ...
                                                    <textarea name="pekerjaan" class="form-control" rows="3"><?= $kerja['isi_aktivitas']?></textarea>
                                                    </div>
                                        ...
                                        <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary" onclick="$('#formadd<?= $kerja['id_aktivitas']; ?>').submit()">Simpan</button>
                                          </div>
                                          </div>
                                      </div>
                                      </div>
...
<!-- Modal -->
<div class="modal fade" id="edit_kerja" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tambah Pekerjaan</h5>
      ...
      <div class="modal-body">
      <form class="" action="<?= site_url('absen/edit_kerja');?>" method="post" id="formadd">
                <div class="form-row">
                  <div class="form-group col-md-5">
                    <label for="start_h">Mulai</label>
                    <div class="row">
